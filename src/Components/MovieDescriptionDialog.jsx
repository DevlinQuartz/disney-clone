...
function MovieDescriptionDialog({movie, isSearchResult = false}) {
  ...
  return (
    <div className={`p-4 bg-[#1A1A1A]/30 backdrop-blur-md rounded-lg w-[300px] md:w-[500px] 
      ${isSearchResult ? 'h-[300px] md:h-[488px]' : 'h-[200px] md:h-[340px]'} 
      border-[1px] border-white transition-all duration-300 ease-in-out z-[999] mx-5 md:mx-10 overflow-visible shadow-xl`}>
